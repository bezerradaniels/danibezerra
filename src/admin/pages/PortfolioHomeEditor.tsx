...
export default function PortfolioHomeEditorPage() {
  const { portfolioHome, setPortfolioHome, uploadImage } = useSiteData()
  const [items, setItems] = useState<PortfolioItem[]>(portfolioHome)
  ...
  const handleAddItem = () => {
    setItems([...items, { image: '', title: '', category: '' }])
  }
  ...
  return (
    <AdminLayout>
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-slate-900">Portfólio Home</h1>
          <p className="mt-1 text-slate-500">Slider de projetos na página inicial</p>
        </div>
        <button
